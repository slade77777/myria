      ...
      <div className={`${headerNavSpacingClassName} terms-conditions mx-auto max-w-[832px]`}>
        <div className="pt-[80px] pb-[160px]">
          ...
          <div className="mt-6">
            ...
            <div className="text-base/9  list-disc  space-y-1 font-light leading-[24px] ">
          ...
          <div className="mt-6">
            ...
            <div className="text-base/9  list-disc  space-y-1 pl-2 font-light leading-[24px] ">
              <p>Follow Myria on Twitter</p>
              <p>
                Follow Brendan
              ...
              <p>Invite Friends (Referrals), via referral link that will be provided by Myria</p>
              <p>Join Discord</p>
              <p>Daily log in to Discord</p>
              <p>Share a post on Twitter</p>
              <p>Reaching Citizen Status (Activity Status) on Discord</p>
            </div>
          </div>
          {/* Prizes */}
          <div className="mt-6">
          ...
          <div className="mt-6">
            ...
            <div className="text-base/9  list-disc  space-y-1 font-light leading-[24px] ">
              <p className="text-justify">
                ...
                suspend the Campaign should virus, bug, non-authorized human intervention, fraud, or
                other cause beyond Myria control corrupt or affect the administration, security,
                fairness, or proper conduct of the Campaign. In such a case, Myria may select the
                Winner from all eligible entries posted prior to and/or after (if appropriate) the
                action taken by Myria. Myria reserves the right, in its sole discretion, to
                disqualify any individual who tampers or attempts to tamper with the entry process
                or the operation of the Campaign or website or violates these Terms & Conditions.
                Myria has the right, in its sole discretion, to maintain the integrity of the
                Campaign, to void votes for any reason, including, but not limited to: multiple
                entries from the same user from different IP addresses; multiple entries from the
                same computer in excess of that allowed by Campaign rules; or the use of bots,
                ...
                Campaign may be a violation of criminal and civil laws. Should such an attempt be
                made, Myria reserves the right to seek damages to the fullest extent permitted by
                law.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6">
            <span className=" text-xl font-bold leading-[26px]	">10. Limitation of Liability</span>
            <div className="text-base/9  list-disc  space-y-1 font-light leading-[24px] ">
              <p className="text-justify">
                By participating, you agree to release and hold harmless Myria and its subsidiaries,
                ...
                injury, death, loss, litigation, claim, or damage that may occur, directly or
                indirectly, whether caused by negligence or not, from: (i) such entrant’s
                participation in the Campaign and/or his/her acceptance, possession, use, or misuse
                of any prize or any portion thereof; (ii) technical failures of any kind, including
                but not limited to the malfunction of any computer, cable, network, hardware, or
                software, or other mechanical equipment; (iii) the unavailability or inaccessibility
                of any transmissions, telephone, or Internet service; (iv) unauthorized human
                intervention in any part of the entry process or the Promotion; (v) electronic or
                human error in the administration of the Promotion or the processing of entries.
              </p>
            </div>
          </div>
          {/* 11. Disclaimer */}
          <div className="mt-6">
            ...
            <div className="text-base/9  list-disc  space-y-1 font-light leading-[24px] ">
              <p className="text-justify">
                In accepting these Terms and Conditions, You give Myria permission to communicate by
                email for relevant and related commercial emails. Myria may use email addresses to
                periodically send promotional emails about products and services, offers or updates
                relating to recent developments in our services that may be relevant. In accordance
                with The Unsolicited Electronic Messages Act, if You do not wish to receive such
                emails, please advise us and we will immediately unsubscribe that person from such
                emails. Myria will not authorize any third party to use Your email addresses to send
                unsolicited emails.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="text-base/9  list-disc  space-y-1 font-light leading-[24px] ">
              <p className="text-justify">
                ...
                parties, and causes of action arising out of or connected with this Campaign, shall
                be resolved individually, without resort to any form of class action, exclusively
                before a court located in The Cayman Islands having jurisdiction. Further, in any
                such dispute, under no circumstances shall participant be permitted to obtain awards
                for, and hereby waives all rights to, punitive, incidental, or consequential
                damages, including reasonable attorney’s fees, other than participant’s actual
          ...
          <div className="mt-6">
            ...
            <div className="text-base/9  list-disc  space-y-1 font-light leading-[24px] ">
              <p className="text-justify">The Sponsor of the Campaign is Myria.</p>
            </div>
          </div>

          {/* 14. */}
          <div className="mt-6">
            <span className=" mt-6  text-xl font-bold leading-[26px]	">14.</span>
            <div className="text-base/9  list-disc  space-y-1 font-light leading-[24px] ">
              <p className="text-justify">
