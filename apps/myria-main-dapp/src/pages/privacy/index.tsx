    ...
    <Page action="mint">
      <div className={`${headerNavSpacingClassName} mx-auto max-w-[832px]`}>
        <div className="pt-[80px] pb-[160px]">
          <div>
            <h1 className="text-[40px] font-bold leading-[60px] text-white">Privacy Notice</h1>
          </div>
          ...
          <div className="mt-8">
            <div className="text-base/9 mt-4 list-disc pl-4 font-light leading-[24px]">
              <div className="space-y-2">
                ...
                <p>
                  Myria is committed to processing personal data in accordance with applicable law.
                  In its use of personal data, certain members of Myria will be characterised under
                  applicable law as a data controller, whilst certain of Myria’s service providers,
                  Affiliates and delegates may act as data processors under applicable law. For the
                  purposes of this Privacy Notice, we, us or our means each member of Myria in its
                  capacity (as relevant) as data controller of the personal data and You or Your
                ...
                <p>
                  ...
                  data by which individuals may be directly or indirectly identified. We may combine
                  personal data that You provide to us with personal data that we collect from or
                  about You. This may include personal data collected in an online or offline
                  context including from credit reference agencies and other available public
                ...
                <ul className="ml-4 list-decimal">
                  ...
                  <li>
                    ...
                    marketing purposes; or (ii) to help detect, prevent, investigate, and prosecute
                    fraud and/or other criminal activity, and share this data with legal,
                    compliance, risk and managerial staff to assess suspicious activities; and/or
                  </li>
                  <li>
                ...
                <ul className="ml-4 list-decimal">
                  ...
                  <li>
                    the right to withdraw Your consent and require us to stop processing or restrict
