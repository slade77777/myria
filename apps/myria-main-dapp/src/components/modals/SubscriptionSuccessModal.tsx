...
const SubscriptionSuccessModal: React.FC<Props> = ({ open, onClose }) => {
  return (
    <Modal open={open}>
        ...
        <div className="relative isolate p-6 text-white md:px-[31px] md:pt-6 md:pb-[38px]">
          ...
          <div className="space-y-8">
            <h1 className="font-bold leading-[1.15] md:text-[24px]">
              <Trans>Thanks for your subscription!</Trans>
            </h1>
            <div>
              <p className="text-base text-light">
                We will keep you posted with our development updates.
              </p>
            </div>
            <button
              onClick={onClose}
