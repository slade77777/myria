...
export default function SelectOrderBy(props: any) {
  ...
  return (
    <Listbox
      ...
      <div className={clsx('relative z-50 mt-1', props.containerStyle)}>
        <Listbox.Button
          className={clsx(
            props.buttonStyle,
          ...
          <span className="block truncate">{companySize?.name ?? dataDefault.title}</span>
        ...
        <Transition
          ...
          leaveTo="opacity-0">
          <Listbox.Options className="bg-base/3 absolute right-0 mt-2 max-h-60 w-full min-w-[300px] overflow-auto rounded-xl py-4  text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
