        ...
        <div className='p-8'>
        {
            ...
            <div className='text-white mt-[20px]'>
                <div className='flex flex-col justify-center items-center'>
                    <CartIcon size={64} />
                    <h3 className='font-medium text-[24px] mt-[24px]'><Trans>Complete checkout</Trans></h3>
                    <p className='font-normal mt-[16px] text-base/9'><Trans>Ultra rare Vector Prime Sigil</Trans></p>
                </div>
                ...
                </Button>
                {
                    ...
                    <Button 
                        disabled
                        className="btn-lg bg-base/8 my-8 w-[120px] h-[50px]">
                        <ProgressIcon size={23}/>
                    </Button>
                    ) : (
                    <Button 
                        className="btn-lg btn-primary my-8 w-[120px] h-[50px]" onClick={InProgressPurchase}>
                        <Trans>CONFIRM</Trans>
                    </Button>
                    )
                }
            ...
            <div className='text-white mt-[20px]'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <h3 className='font-medium text-[24px] mt-[24px]'><Trans>Purchase Successful</Trans></h3>
                    <p className='font-normal mt-[16px] text-base/9'><Trans>Ultra rare Vector Prime Sigil</Trans></p>
                </div>
                <div className='bg-base/2 p-4 rounded-[8px] text-[16px] mt-[32px]'>
                <div className='flex justify-between'>
                ...
                <div className='flex justify-between mt-2'>
                    <span className='text-base/9'><Trans>Transaction History</Trans></span>
                    <span className='text-primary/6'><Trans>View</Trans></span>
                </div>
                </div>
