    ...
    <div className="mt-[29px]">
      <div className='px-[25px]'>
        ...
        <div className="text-base/9 text-[14px] text-center mt-4">
          <span><Trans>Your withdrawal was successful, you should now see your item in your L1 wallet.</Trans></span>
        </div>
      </div>
      <div className="mt-[32px] text-[14px] font-normal rounded-[8px] bg-base/2/[.5] p-4 text-white">
        <div className="flex justify-between">
          <span className='text-base/9'><Trans>Item</Trans></span>
          <span className="flex font-medium">
            {valueNFT.name}
          </span>
        </div>
        <div className="mt-[13px] flex justify-between">
          <span className='flex items-center text-base/9'><Trans>Transaction ID</Trans></span>
          <span className='flex items-center text-[#F5B941] font-medium cursor-pointer'><Trans>View</Trans></span>
        </div>
      </div>
