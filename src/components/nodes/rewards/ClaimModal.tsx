        ...
        <div>
          <div className="px-8 pt-[62px] pb-[67px]">
            <div className="flex items-center justify-between">
              <p className="text-[24px] leading-[1.3]">NFT Rewards</p>
              <p className="text-[18px] leading-[1.5] text-light">Quantity: 3</p>
            </div>
            <div className="my-4 h-[1px] w-full bg-white opacity-10" />
            <div className="flex items-center justify-between">
              <p className="text-[24px] leading-[1.3]">Gas Fee</p>
          ...
          <div className="bg-dark/50 p-8">
            <div className="flex items-center justify-between">
              <p className="text-[24px] leading-[1.3]">Total</p>
              <div className="text-right">
                <div className="flex items-center space-x-2">
                  <ETH width={14.4} />
            ...
            <div className="mt-1 flex items-end justify-between">
              <div className="space-y-2">
                <p className="text-[18px] leading-[1.5] text-light">From wallet</p>
              ...
              <button className="btn-lg btn-primary w-[260px]">COLLECT NOW</button>
            </div>
          </div>
        </div>
      </Modal.Content>
