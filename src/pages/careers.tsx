            ...
            <div className="grid md:grid-cols-2 gap-[32px] mt-[170px] items-center">
              ...
              <div>
                ...
                <p className="mt-6 body">
                  If you want to make a real impact in gaming and blockchain,
                  join us at Myria. We’re scouring the world for the best and
                  brightest to join our rapidly growing company.
                </p>
