    ...
    <Page>
      <div>
          ...
          <div className="max-w-content w-full mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-y-[53px] gap-x-[83px]">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="mt-6 body-sm md:body-lg text-light">
                ...
                characters, and rich storylines that carry across each game
                world, and Myria tokens and NFTs can be used across the
                Myriaverse.
              </p>
              <button className="btn-lg btn-primary mt-[45px]">
                LEARN MORE
              </button>
            </div>
          </div>
            ...
            <div className="w-full text-center max-w-content md:text-left">
              <div>
                ...
                <div className="max-w-[616px] mt-6 text-light body-sm md:body-lg">
                  ...
                  <p className="mt-6">
                    Operate a Myria node from your home computer and earn
                    rewards for your contribution to the network.
                  </p>
                </div>
        ...
        <section className={clsx(paddingX, "mt-[123px] md:mt-[152px]")}>
          <h2 className="text-center heading-md md:heading-lg">
            Our Experience
          </h2>
