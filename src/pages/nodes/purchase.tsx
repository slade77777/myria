  ...
  return (
    <Page>
      <div
        ...
        className={clsx(
          "bg-top-right bg-[url('/images/nodes/purchase-page-bg.png')] bg-no-repeat"
        )}>
        <div>
          <div className="mx-auto w-full max-w-[1734] px-[88px]">
            <section>
            ...
            <div>
              <section className="mt-[80px]">
                <div className="rounded-lg bg-brand-deep-blue p-8 md:max-w-[832px]">
                  <p className="heading-md text-white">Myria Node License</p>
                  <p className="body-sm mt-6 mr-[42px] font-normal text-light">
                    Grow with us and be rewarded. A Myria Node License allows you to operate a node
                    from your home computer to support the growth of Myria’s decentralized network.
                    As a node owner, you’ll earn daily rewards and exclusive benefits for your
                    contribution.
                  </p>
                  <img src={'/images/dashboard.png'} className="mt-[59px] w-full" alt="" />
                  {licenses.map((item, idx) => {
                    return (
                      <div key={idx} className="mt-6 flex items-center bg-dark px-8 py-6">
                        ...
                        <div className=" ml-8 ">
                          ...
                          <p className="body-sm mt-2 font-normal text-light">{item.content}</p>
                        </div>
                      </div>
                    );
                  })}
              ...
              <section className="mt-[152px]">
                <h2 className="heading-sm text-center md:heading-md">Nod owner rewards</h2>
        ...
        <section className={clsx(paddingX, 'mx-auto mt-[152px] w-full max-w-[832px]')}>
          <h3 className="heading-sm text-center md:heading-md">Validating on Myria</h3>
